...
public class XStreamAnnotationSample {
	...
	public static void objectToXml()throws Exception{
		User user = getUser();
		FileOutputStream fs = new FileOutputStream("javalibs/src/main/java/xml/outxml/XStreamAnnotationSample.xml");
	...
	public static User xmlToObject()throws Exception{
		FileInputStream fis = new FileInputStream("javalibs/src/main/java/xml/outxml/XStreamAnnotationSample.xml");
